...
@Getter
public class SchedulesFile extends Handler {

    public static File file;
    public static YamlConfiguration configuration;

    public SchedulesFile(HCF plugin) {
        super(plugin);
    ...
    public static void load() {
        file = new File(HCF.getInstance().getDataFolder(), "schedules.yml");

        if(!file.exists()) {
            HCF.getInstance().saveResource("schedules.yml", false);
        }
