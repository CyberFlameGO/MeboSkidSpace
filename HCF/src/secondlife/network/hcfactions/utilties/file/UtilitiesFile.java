...
@Getter
public class UtilitiesFile extends Handler {

	public static File file;
	public static YamlConfiguration configuration;

	public UtilitiesFile(HCF plugin) {
		super(plugin);
		
		file = new File(plugin.getDataFolder(), "utilities.yml");
		
		if(!file.exists()) {
			plugin.saveResource("utilities.yml", false);
		}
	...
	public static void load() {
		file = new File(HCF.getInstance().getDataFolder(), "utilities.yml");
		
		if(!file.exists()) {
			HCF.getInstance().saveResource("utilities.yml", false);
		}
