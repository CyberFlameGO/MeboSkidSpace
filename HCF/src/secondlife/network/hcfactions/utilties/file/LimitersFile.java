...
@Getter
public class LimitersFile extends Handler {

	public static File file;
	public static YamlConfiguration configuration;

	public LimitersFile(HCF plugin) {
		super(plugin);
		
		file = new File(plugin.getDataFolder(), "limiters.yml");
		
		if(!file.exists()) {
			plugin.saveResource("limiters.yml", false);
		}
	...
	public static void load() {
		file = new File(HCF.getInstance().getDataFolder(), "limiters.yml");
		
		if(!file.exists()) {
			HCF.getInstance().saveResource("limiters.yml", false);
		}
