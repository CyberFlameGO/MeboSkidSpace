...
@Getter
public class ArenaFile extends Handler {

    public static File file;
    public static YamlConfiguration configuration;

    public ArenaFile(Practice plugin) {
        super(plugin);
    ...
    public static void load() {
        file = new File(Practice.getInstance().getDataFolder(), "arenas.yml");

        if(!file.exists()) {
            Practice.getInstance().saveResource("arenas.yml", false);
        }
