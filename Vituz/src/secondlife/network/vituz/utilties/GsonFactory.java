...
public class GsonFactory {
    ...
    /**
     * Returns a Gson plugin for use anywhere with new line pretty printing
     * <p>
     *    Use @GsonIgnore in order to skip serialization and deserialization
     * </p>
     * @return a Gson plugin
     */
    ...
    /**
     * Returns a Gson plugin for use anywhere with one line strings
     * <p>
     *    Use @GsonIgnore in order to skip serialization and deserialization
     * </p>
     * @return a Gson plugin
    ...
    /**
     * Creates a new plugin of Gson for use anywhere
     * <p>
     *    Use @GsonIgnore in order to skip serialization and deserialization
     * </p>
     * @return a Gson plugin
    ...
    private static class NewItemStackAdapter extends TypeAdapter<ItemStack> {
        ...
        public ItemStack read(JsonReader jsonReader) throws IOException {
            ...
            if (next.startsWith("{")) {
                ...
                try {
                    compound = (NBTTagCompound) MojangsonParser.parse(ChatColor.translateAlternateColorCodes('&', next));
