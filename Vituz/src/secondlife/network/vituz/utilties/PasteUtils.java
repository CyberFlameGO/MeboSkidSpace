...
public class PasteUtils {
	...
	public PasteResult uploadMongo(List<String> list) throws IOException {
		String response = "";
		URL url = new URL(POST_URL);
		HttpURLConnection conn = (HttpURLConnection) url.openConnection();
	 ...
	 */
	public enum Expire {
		NEVER("N"), FIVE_MINUTES("5M"), TEN_MINUTES("10M"), ONE_HOUR("1H"), ONE_DAY("1D"), ONE_WEEK("1W"), TWO_WEEKS("2W"), ONE_MONTH("1M");
