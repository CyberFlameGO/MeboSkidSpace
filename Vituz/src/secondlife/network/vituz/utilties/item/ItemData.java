package secondlife.network.vituz.utilties.item;
...
public class ItemData implements ConfigurationSerializable {
	...
	public static ItemData fromItemName(String string) {
		ItemStack stack = Vituz.getInstance().getItemDB().getItem(string);
	...
	public String getItemName() {
		return Vituz.getInstance().getItemDB().getName(new ItemStack(this.material, 1, this.itemData));
	}
