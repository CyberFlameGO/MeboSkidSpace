package secondlife.network.uhc.border.worldborder;
...
import secondlife.network.uhc.border.worldborder.api.DynmapAPI;
import secondlife.network.uhc.border.worldborder.api.markers.AreaMarker;
import secondlife.network.uhc.border.worldborder.api.markers.CircleMarker;
import secondlife.network.uhc.border.worldborder.api.markers.MarkerAPI;
import secondlife.network.uhc.border.worldborder.api.markers.MarkerSet;
...
public class DynMapFeatures
{
	...
	public static void setup()
	{
		...
		try
		{
			Class.forName("me.uhc.dynmap.markers.CircleMarker");
