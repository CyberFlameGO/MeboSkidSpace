package secondlife.network.uhc.border.worldborder.api.markers;
...
public interface MarkerSet {
     ...
     * @param is_persistent - if true, marker is persistent (saved and reloaded on restart).  If set isn't persistent, this must be false.
     * @return created marker, or null if can't be created.
     */
     ...
     * @return marker, or null if can't be found
     */
