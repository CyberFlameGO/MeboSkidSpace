package secondlife.network.uhc.border.worldborder.api.renderer;

import java.util.List;
import java.util.Map;

import secondlife.network.uhc.border.worldborder.api.renderer.RenderPatchFactory.SideVisible;
