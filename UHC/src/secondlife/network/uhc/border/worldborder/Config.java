...
//	public static long timeUsed = 0;
	...
	public static void setRemountTicks(int ticks)
	{
		...
		else
		{
			...
			if (ticks < 10)
				logWarn("setting the remount delay to less than 10 (and greater than 0) isn't recommended. This can lead to nasty client glitches.");
		}
		save(true);
	}
	...
	public static void load(UHC master, boolean logIt)
