...
import secondlife.network.uhc.deathlookup.DeathLookup;
...
public class DeathData {
    ...
    private void saveFights() {
        for (ProfileFight fight : this.fights) {
            ...
            Vituz.getInstance().getDatabaseManager().getUhcDeaths().replaceOne(eq("uuid", fight.getUuid().toString()), document, new UpdateOptions().upsert(true));
        }
    ...
    public void save() {
        ...
        Vituz.getInstance().getDatabaseManager().getUhcDeaths().replaceOne(eq("name", this.name.toLowerCase()), document, new UpdateOptions().upsert(true));
    ...
    public void load() {
        Document document = (Document) Vituz.getInstance().getDatabaseManager().getUhcDeaths().find(eq("name", name.toLowerCase())).first();
