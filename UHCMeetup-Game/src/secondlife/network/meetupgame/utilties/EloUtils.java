...
/**
 * Created by R4pexay on 24.07.2018.
 */
public class EloUtils {

    public static int getElo(MeetupData killerData, MeetupData victimData) {
    ...
    public static int giveElo(MeetupData killedData) {
        return Math.round(killedData.getElo() / 100);
    }

    public static int giveWinnerElo(MeetupData winnerData) {
